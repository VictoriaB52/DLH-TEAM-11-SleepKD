...
def run_sleepkd_deepsleepnet():
    ...
    teacher = DeepSleepNetTeacher(name="TeacherModel", data=x_train, labels=y_train,
    ...
    student = DeepSleepNetStudent(name="StudentModel", data=x_train, labels=y_train,
                                  training_epochs=training_epochs, batch_size=batch_size,
                                  model_dir=student_dir)
    student_model = student.get_model(should_train=True)
